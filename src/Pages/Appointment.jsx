...
const Appointment = () => {
  ...
  const getAvailableSlots = async () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      // set the end time to 9 PM of the same day
      let endTime = new Date(currentDate);
      endTime.setHours(21, 0, 0, 0);

      // setting hours depending on if it's today or future days
      if (currentDate.getHours() === today) {
      ...
      <div>
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
            {/* ------------- name , age , discription and etc about this  */}
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 max-w-[780px] mt-1">
                {docInfo.about}
              </p>
            </div>
